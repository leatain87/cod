...
class menuChronoForms {
	...
	public static function form_wizard_menu(){
		$formname = "New Form...";
		$form_id = JRequest::getVar('form_id', 0);
		//if(isset($_GET['formname']) && !empty($_GET['formname'])){
		if(!empty($form_id)){
			$database = JFactory::getDBO();
			$query = "SELECT `name` FROM `#__chronoforms` WHERE `id` = '".$form_id."'";
	...
	public static function admin_form_menu(){
	...
	public static function create_table_menu(){
	...
	public static function validatelicense_menu(){
