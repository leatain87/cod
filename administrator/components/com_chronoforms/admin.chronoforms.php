...
require_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'admin.chronoforms.html.php'); 
require_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'chronoforms.class.php');

$jversion = new JVersion();
require_once(JPATH_SITE.DS."administrator".DS."components".DS."com_chronoforms".DS."controller.php");
require_once(JPATH_SITE.DS."administrator".DS."components".DS."com_chronoforms".DS."versions".DS."j".substr($jversion->RELEASE, 0, 1).DS."admin.chronoforms.php");
?>
<?php
...
require_once(JPATH_SITE.DS."administrator".DS."components".DS."com_chronoforms".DS."toolbar.chronoforms.php");
