...
if($jversion->RELEASE >= 3.2 AND false){
	$options = array('theme' => 'modern', 'theme_advanced_toolbar_location' => 'top', 'width' => '100%', 'height' => '200px');
}else{
...
?>
<script type="text/javascript" src="<?php echo JURI::Base(); ?>components/com_chronoforms/js/tiny_mce/tiny_mce.js"></script>
<?php elseif($jversion->RELEASE > 1.5 AND $jversion->RELEASE < 3.2): ?>
