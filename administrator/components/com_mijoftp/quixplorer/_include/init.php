...
require JPATH_MIJOFTP_QX."/_include/error.php";
...
if (!is_readable(JPATH_MIJOFTP_QX."/_config/conf.php"))
    show_error(JPATH_MIJOFTP_QX."/_config/conf.php not found.. please see installation instructions");

require JPATH_MIJOFTP_QX."/_config/conf.php";
require JPATH_MIJOFTP_QX."/_config/configs.php";
if(isset($GLOBALS["lang"])) $GLOBALS["language"]=$GLOBALS["lang"];
require JPATH_MIJOFTP_QX."/_lang/".$GLOBALS["language"].".php";
require JPATH_MIJOFTP_QX."/_lang/".$GLOBALS["language"]."_mimes.php";
require JPATH_MIJOFTP_QX."/_config/mimes.php";
require JPATH_MIJOFTP_QX."/_include/fun_extra.php";
require_once JPATH_MIJOFTP_QX."/_include/header.php";
require JPATH_MIJOFTP_QX."/_include/footer.php";
ob_start(); // prevent unwanted output
require_once JPATH_MIJOFTP_QX."/_include/login.php";
